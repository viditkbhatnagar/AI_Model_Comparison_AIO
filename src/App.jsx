    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 p-4 md:p-6">
      <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm border border-slate-100">
                ...
                <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-200">
                  ...
                  <div className="text-sm text-emerald-800 space-y-2">
                    <ul className="list-disc list-inside space-y-1">
                      ...
                      <li>AI_v2 maintains performance advantage over AI_v1</li>
                      <li>No significant volatility in historical data</li>
                      <li>Improvement rate is sustainable (not exponential)</li>
                    </ul>
                  </div>
                </div>

                <div className="p-4 bg-purple-50 rounded-xl border border-purple-200">
                  <h4 className="font-semibold text-purple-700 mb-3">💡 Recommendations</h4>
                  <div className="text-sm text-purple-800 space-y-2">
                    <ul className="list-disc list-inside space-y-1">
                      <li><strong>Monitor monthly:</strong> Track actual vs forecasted performance</li>
                      <li><strong>Adjust models:</strong> Retrain AI models quarterly with new data</li>
                      <li><strong>Department focus:</strong> Prioritize departments with lower trends</li>
                      <li><strong>Risk mitigation:</strong> Have fallback procedures if accuracy drops</li>
                      <li><strong>Continuous improvement:</strong> Feed prediction errors back into training</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-indigo-100 to-purple-100 rounded-xl border border-indigo-200">
                ...
                <p className="text-sm text-indigo-700">
                  Based on the linear regression analysis of {csvData.length} hospital records across {departments.length} departments, 
                  the 6-month forecast shows <strong>continued improvement</strong> for both AI models. 
                  AI_v2 is projected to maintain a <strong>{((overallScores.v2 / overallScores.v1 - 1) * 100).toFixed(0)}% performance advantage</strong> over AI_v1. 
                  However, these projections assume stable operational conditions. Regular monitoring and model retraining are recommended 
                  to ensure forecasted improvements are achieved.
                </p>
              </div>
            </div>
          </>
        ...
        <div className="text-center mt-8 text-slate-400 text-sm">
          <p>Hospital AI Model Analysis Dashboard • Based on {csvData.length} patient records</p>
        </div>
      </div>
    </div>
  );
